...
- Microphone input, used for tuner pitch detection.
- Audio files selected by the user, used for playback and practice tools.
- App settings, presets, practice logs, and usage limits stored on the device.
- Advertising-related data processed by Google Mobile Ads when ads are enabled.
- Crash diagnostics and app performance data if crash reporting is enabled.
- Feedback content submitted by the user through the beta feedback form.
...
Beta testers may submit feedback through a Google Form or another feedback channel. Feedback may include information the tester chooses to provide, such as email address, device model, operating system version, screenshots, and issue descriptions.
...
Local app data remains on the device until the user deletes it or uninstalls the app. Feedback and diagnostic data may be retained as needed to improve app quality and resolve issues.
...
Contact: chocolemon0623@gmail.com

## Changes

We may update this policy when app features, service providers, or legal requirements change.
